...
// import { AssistantMessage } from "@/_aaa_sheetChat/_types/chat.types";
...
//       {/* 실행 오류 메시지 */}
//         {executionError && (
//           <div className="mt-3 p-4 bg-red-50 border-red-400 rounded-lg shadow-sm">
...
//             className="flex-shrink-0 ml-3 p-1 rounded-md text-red-400 hover:text-red-600 hover:bg-red-100 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"
