// // components/ArtifactRenderComponent.tsx
// 'use client'
...
//   useEffect(() => {
//     if (computedData || rawCsvData) {
//       setRenderKey(prev => prev + 1);
//       setRenderError(null);
//     }
//   }, [computedData, rawCsvData]);

//   // 렌더링할 컴포넌트 메모이제이션
//   const RenderedComponent = useMemo(() => {
//     if (!artifactCode || !rawCsvData) return null;
...
//       return null;
//     }
//   }, [artifactCode, rawCsvData, computedData, renderKey]);
