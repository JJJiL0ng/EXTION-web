      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-12">
          ...
          <Link href="/invite-check">
            <Button
              size="sm"
              className="bg-[#005de9] hover:bg-blue-700 px-2 py-2 text-xs sm:px-2 sm:py-2 sm:text-md transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg rounded"
            >
