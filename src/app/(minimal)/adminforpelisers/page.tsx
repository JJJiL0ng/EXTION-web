//src/app/adminforpel!sers/page.tsx
'use client'
...
function AdminPageContent() {
  ...
  const handleAdminLogout = () => {
    ...
    document.cookie = 'adminLoggedIn=; path=/; max-age=0'; // 쿠키 삭제
  ...
  return (
    ...
    >
      {/* 어드민 헤더 */}
      <div className="absolute top-0 left-0 right-0 z-50 bg-gradient-to-r from-blue-600 to-blue-700 text-white p-2 shadow-lg">
        <div className="flex justify-between max-w-7xl mx-auto">
          ...
          <button
            ...
            className="flex items-center space-x-1 bg-blue-800 hover:bg-blue-900 px-3 py-1 rounded-md transition-colors text-sm"
          >
