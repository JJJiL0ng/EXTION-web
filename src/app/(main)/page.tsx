import { HeroSection } from '@/_lending/lendingComponents/lending/sections/HeroSection'
import { FeatureSection } from '@/_lending/lendingComponents/lending/sections/FeatureSection'
import { DeviceSection } from '@/_lending/lendingComponents/lending/sections/DeviceSection'
import { ReviewSection } from '@/_lending/lendingComponents/lending/sections/reviewSection'
import { CTASection } from '@/_lending/lendingComponents/lending/sections/CTASection'
import { heroData, generateHeroStructuredData } from '@/_lending/lendingComponents/lending/data/hero'
import { featuresData, generateFeaturesStructuredData, getAllFeatureKeywords } from '@/_lending/lendingComponents/lending/data/features'
import { devicesData, generateDevicesStructuredData, getAllDeviceKeywords } from '@/_lending/lendingComponents/lending/data/devices'
import { reviewsData, generateReviewsStructuredData, getAllReviewKeywords } from '@/_lending/lendingComponents/lending/data/review'
import { ctaData, generateCTAStructuredData } from '@/_lending/lendingComponents/lending/data/cta'
